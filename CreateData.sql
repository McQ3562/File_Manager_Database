...
/*** Data Item ***/
EXEC sp_ADD_DataItem @LibraryFolderID=@DirID, @DataItemLabel='Orbital period', @DataItemValue='0.241 earth years'
EXEC sp_ADD_DataItem @LibraryFolderID=@DirID, @DataItemLabel='Rotational period', @DataItemValue='58.646 earth days'
